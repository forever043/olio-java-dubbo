...
import org.apache.olio.webapp.model.PersonView;
    ...
    public String process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (actionType == null) { // treat it as a read
            ...
            if (actionType.equals(GET_FRIENDS)) {
                PersonView p = new PersonView(getPerson(request));
                if (p != null) {
...
//    private Person createUser(HttpServletRequest request, Hashtable<String, String> htUpload) {
    ...
    private Person updateUser(Person person, Hashtable<String, String> htUpload) {
        ...
        PersonService personService = (PersonService) context.getAttribute(DUBBO_PERSON_SERVICE_KEY);
        Person loggedInPerson = personService.getPerson(userName, Person.PERSON_EXT_ADDRESS);
        if (loggedInPerson != null) {
            if (thumbImage == null) {

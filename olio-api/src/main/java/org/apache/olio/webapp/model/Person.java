...
/*
    public String toJson() {
        ...
        sb.append("{\"person\":{ ");
        sb.append("\"userName\":\"");
        sb.append(this.encodeJSONString(userName));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"firstName\":\"");
        sb.append(this.encodeJSONString(firstName));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"lastName\":\"");
        sb.append(this.encodeJSONString(lastName));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"summary\":\"");
        sb.append(this.encodeJSONString(summary));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"email\":\"");
        sb.append(this.encodeJSONString(email));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"telephone\":\"");
        sb.append(this.encodeJSONString(telephone));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"imageURL\":\"");
        sb.append(this.encodeJSONString(imageURL));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"imageThumbURL\":\"");
        sb.append(this.encodeJSONString(imageThumbURL));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"address\":\"");
        sb.append(this.encodeJSONString(address.toString()));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        
        sb.append("\"timezone\":\"");
        sb.append(this.encodeJSONString(timezone));
        sb.append(DOUBLE_QUOTE);
        sb.append(COMMA);
        ...
        if (getFriends().size() > 0) {
            for (Person p : getFriends()) {
                sb.append(DOUBLE_QUOTE);
                sb.append(this.encodeJSONString(p.getUserName()));
                sb.append(DOUBLE_QUOTE);
                sb.append(COMMA);
            }
        ...
        if (getFriends().size() > 0) {
            for (Person p : getFriends()) {
                ...
                sb.append(COMMA);
                sb.append("\"imageThumbURL\":\"");
                sb.append(this.encodeJSONString(p.getImageThumbURL()));
                sb.append(DOUBLE_QUOTE);
                sb.append("}");
                sb.append(COMMA);
            }
        ...
        if (getSocialEvents().size() > 0) {
            for (SocialEvent event : getSocialEvents()) {
                if(event.getSubmitterUserName().equals(userName)) {
                    ...
                    sb.append(DOUBLE_QUOTE);
                    sb.append(this.encodeJSONString(String.valueOf(event.getSocialEventID())));
                    sb.append(DOUBLE_QUOTE);
                    sb.append(COMMA);
                    sb.append("\"title\":");
                    sb.append(DOUBLE_QUOTE);
                    sb.append(this.encodeJSONString(event.getTitle()));
                    sb.append(DOUBLE_QUOTE);
                    sb.append(COMMA);
    ...
    public String getOutgoingInvitationsAsJson() {
        ...
        if (getOutgoingInvitations().size() > 0) {
           for (Invitation inv : getOutgoingInvitations()){
               ...
               sb.append(":");
               sb.append(DOUBLE_QUOTE);
               sb.append(this.encodeJSONString(inv.getCandidate().getUserName()));
               sb.append(DOUBLE_QUOTE);
               sb.append(COMMA);
               sb.append(DOUBLE_QUOTE);
               sb.append("fullname");
               ...
               sb.append(":");
               sb.append(DOUBLE_QUOTE);
               sb.append(this.encodeJSONString(inv.getCandidate().getFirstName() + " " + inv.getCandidate().getLastName()));
               sb.append(DOUBLE_QUOTE);
               sb.append("}");
           }
           sb.deleteCharAt(sb.length()-1);//remove last space
    ...
    private static String encodeJSONString(String json) {
        if (json == null)
            return "";
